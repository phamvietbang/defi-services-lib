...
if __name__ == "__main__":
    valas = ValasService("0x38","https://rpc.ankr.com/bsc")
    apy = valas.get_apy_defi_app()
    deposit_borrow = valas.get_wallet_deposit_borrow_balance(
        wallet_address="0xa3CDBDCa01719Faf5fEBFF95c868Fd200F946808",
    )
    claim = valas.get_rewards_balance(wallet_address="0xa3CDBDCa01719Faf5fEBFF95c868Fd200F946808")
    print(claim)
